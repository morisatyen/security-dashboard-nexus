...
const DispensaryEdit: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const updatedDispensary: Dispensary = {
      ...
      email,
      password,
      profilePicture: dispensary!.profilePicture,
    ...
    if (storedData) {
      const dispensaries: Dispensary[] = JSON.parse(storedData);
      const updatedDispensaries = dispensaries.map(d => d.id === id ? updatedDispensary : d);
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Dispensary</h1>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="name" className="text-sm font-medium">Dispensary Name <span className="text-red-500">*</span></label>
                <Input 
                  id="name" 
                  name="name" 
              ...
              <div className="space-y-2">
                <label htmlFor="location" className="text-sm font-medium">Address <span className="text-red-500">*</span></label>
                <Input 
                  id="location" 
                  name="location" 
              ...
              <div className="space-y-2">
                <label htmlFor="contactPerson" className="text-sm font-medium">Contact Person <span className="text-red-500">*</span></label>
                <Input 
                  id="contactPerson" 
                  name="contactPerson" 
